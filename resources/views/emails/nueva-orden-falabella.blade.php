...
<head>
    ...
    <style>
        ...
        .header { background: #6DB33F; padding: 24px 32px; }
        .header h1 { margin: 0; font-size: 20px; color: #fff; }
        .header p { margin: 4px 0 0; font-size: 13px; color: #eafff0; }
...
<div class="wrapper">
    <div class="header">
        <h1>🟢 Nueva orden de Falabella</h1>
    ...
    <div class="body">
        <div class="orden">
            <div class="orden-header">
                ...
                <span class="badge">Falabella</span>
            </div>
    ...
    <div class="footer">
        Sistema GYC — sincronización automática de Falabella
    </div>
</div>
</body>
</html>
